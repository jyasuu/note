...
📋 Plan created with 3 steps
  1. gather_sources - Gather relevant sources and information
  2. analyze_information - Analyze gathered information
  3. synthesize_results - Synthesize findings into final result

⚡ EXECUTION PHASE
🔄 Executing step: gather_sources - Gather relevant sources and information
✅ Completed: Gather relevant sources and information
🔄 Executing step: analyze_information - Analyze gathered information
✅ Completed: Analyze gathered information
🔄 Executing step: synthesize_results - Synthesize findings into final result
✅ Completed: Synthesize findings into final result

🎉 Workflow completed successfully!

Final state keys: ["current_step", "execution_complete", "last_result", "objective", "plan"]

======================================
🚀 Starting plan-and-execute workflow
📝 Objective: Write a report on climate change

📋 PLANNING PHASE
📋 Plan created with 3 steps
  1. outline - Create an outline
  2. draft - Write initial draft
  3. revise - Revise and finalize

⚡ EXECUTION PHASE
🔄 Executing step: outline - Create an outline
✅ Written: Create an outline
🔄 Executing step: draft - Write initial draft
✅ Written: Write initial draft
🔄 Executing step: revise - Revise and finalize
✅ Written: Revise and finalize

🎉 Workflow completed successfully!

Final state keys: ["objective", "last_result", "execution_complete", "current_step", "plan"]
```
